...
public class AdvancementFrameDataLoader extends SimpleJsonResourceReloadListener<List<AdvancementFrameDataLoader.Entry>> {
    ...
    public AdvancementFrameDataLoader() {
        super(Entry.LIST_CODEC, LOCATION);
    }

    @Override
    protected @NotNull Map<ResourceLocation, List<Entry>> prepare(@NotNull ResourceManager resourceManager, @NotNull ProfilerFiller profiler) {
