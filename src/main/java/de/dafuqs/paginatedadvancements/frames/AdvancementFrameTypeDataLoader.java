    ...
    protected void apply(Map<ResourceLocation, JsonElement> prepared, @NotNull ResourceManager resourceManager, @NotNull ProfilerFiller profilerFiller) {
        prepared.forEach((identifier, jsonElement) -> {
            ...
            for (JsonElement frameEntry : object.get("frames").getAsJsonArray()) {
                ...
                ResourceLocation id = new ResourceLocation(identifier.getNamespace(), name);
                ...
                ResourceLocation textureObtained = new ResourceLocation(identifier.getNamespace(), "advancements/" + name + "_obtained");
                ResourceLocation textureUnobtained = new ResourceLocation(identifier.getNamespace(), "advancements/" + name + "_unobtained");
