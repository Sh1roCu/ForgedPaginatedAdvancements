...
public class PaginatedAdvancementWidget extends AdvancementWidget {
    ...
    public void draw(@NotNull GuiGraphics context, int x, int y) {
        ...
        if (!accessor.getDisplay().isHidden() || accessor.getProgress() != null && accessor.getProgress().isDone()) {
            ...
            if (frameWrapper != null) {
                context.blitSprite(frameWrapper.getTexture(advancementObtainedStatus, accessor.getDisplay().getFrame()), x + accessor.getX() + 3, y + accessor.getY(), 26, 26);
                ...
                context.blitSprite(advancementObtainedStatus.frameSprite(accessor.getDisplay().getFrame()), x + accessor.getX() + 3, y + accessor.getY(), 26, 26);
    ...
    public void drawHover(@NotNull GuiGraphics context, int originX, int originY, float alpha, int x, int y) {
        ...
        if (this.frameWrapper != null) {
            context.blitSprite(this.frameWrapper.getTexture(advancementObtainedStatus3, accessor.getDisplay().getFrame()), originX + accessor.getX() + 3, originY + accessor.getY(), 26, 26);
        } else {
            context.blitSprite(advancementObtainedStatus3.frameSprite(accessor.getDisplay().getFrame()), originX + accessor.getX() + 3, originY + accessor.getY(), 26, 26);
        }
