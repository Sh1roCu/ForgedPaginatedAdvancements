...
public class PaginatedAdvancementScreen extends AdvancementsScreen implements ClientAdvancements.Listener {
    ...
    public void drawPaginationButtons(GuiGraphics context, int mouseX, int mouseY, int startX, int endX) {
        if (isClickOnBackTab(mouseX, mouseY, startX, endX)) {
            // hover
            context.blit(PAGINATION_TEXTURE, startX + 4, TOP_ELEMENT_HEIGHT + ADDITIONAL_PADDING_TOP - 15, 0, 23, 23, 23, 256, 256);
        } else {
            // no hover
            context.blit(PAGINATION_TEXTURE, startX + 4, TOP_ELEMENT_HEIGHT + ADDITIONAL_PADDING_TOP - 15, 0, 0, 23, 23, 256, 256);
        }

        if (isClickOnForwardTab(mouseX, mouseY, startX, endX)) {
            // hover
            context.blit(PAGINATION_TEXTURE, endX - startX + 4, TOP_ELEMENT_HEIGHT + ADDITIONAL_PADDING_TOP - 15, 23, 23, 23, 23, 256, 256);
        } else {
            // no hover
            context.blit(PAGINATION_TEXTURE, endX - startX + 4, TOP_ELEMENT_HEIGHT + ADDITIONAL_PADDING_TOP - 15, 23, 0, 23, 23, 256, 256);
        }
    }
    ...
    private void drawFrame(GuiGraphics context, int startX, int startY, int endX, int endY) {
        // corners
        context.blit(WINDOW_TEXTURE, startX, startY, 0, 0, ELEMENT_WIDTH, TOP_ELEMENT_HEIGHT, 256, 256); // top left
        context.blit(WINDOW_TEXTURE, endX - ELEMENT_WIDTH, startY, 237, 0, ELEMENT_WIDTH, TOP_ELEMENT_HEIGHT, 256, 256); // top right
        context.blit(WINDOW_TEXTURE, startX, endY - BOTTOM_ELEMENT_HEIGHT, 0, 125, ELEMENT_WIDTH, BOTTOM_ELEMENT_HEIGHT, 256, 256); // bottom left
        context.blit(WINDOW_TEXTURE, endX - ELEMENT_WIDTH, endY - BOTTOM_ELEMENT_HEIGHT, 237, 125, ELEMENT_WIDTH, BOTTOM_ELEMENT_HEIGHT, 256, 256); // bottom right
        ...
        while (middleHeight > 0) {
            ...
            context.blit(WINDOW_TEXTURE, startX, currentY, 0, TOP_ELEMENT_HEIGHT, ELEMENT_WIDTH, currentDrawHeight, 256, 256);
            context.blit(WINDOW_TEXTURE, endX - ELEMENT_WIDTH, currentY, 237, TOP_ELEMENT_HEIGHT, ELEMENT_WIDTH, currentDrawHeight, 256, 256);
        ...
        while (middleWidth > 0) {
            ...
            context.blit(WINDOW_TEXTURE, currentX, startY, ELEMENT_WIDTH, 0, currentDrawWidth, TOP_ELEMENT_HEIGHT, 256, 256);
            context.blit(WINDOW_TEXTURE, currentX, endY - BOTTOM_ELEMENT_HEIGHT, ELEMENT_WIDTH, 125, currentDrawWidth, BOTTOM_ELEMENT_HEIGHT, 256, 256);
    ...
    @Override
    public void onRemoveAdvancementRoot(@NotNull Advancement root) {
    }

    @Override
    public void onAddAdvancementTask(@NotNull Advancement dependent) {
    ...
    @Override
    public void onRemoveAdvancementTask(@NotNull Advancement dependent) {
    }
    ...
    @Nullable
    public AdvancementWidget getAdvancementWidget(@NotNull Advancement advancement) {
