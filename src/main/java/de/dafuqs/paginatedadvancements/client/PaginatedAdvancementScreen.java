...
public class PaginatedAdvancementScreen extends AdvancementsScreen implements ClientAdvancements.Listener {
        ...
        if (this.selectedTab == null && !this.tabs.isEmpty()) {
            ...
            if (PaginatedAdvancementsClient.CONFIG.SaveLastSelectedTab && !PaginatedAdvancementsClient.CONFIG.LastSelectedTab.isEmpty()) {
                ...
                for (AdvancementTab advancementTab : this.tabs.values()) {
                    if (advancementTab.getRootNode().holder().id().equals(savedTabResourceLocation)) {
        ...
        if (!this.tabs.isEmpty() && PaginatedAdvancementsClient.hasPins()) {
            for (String pinnedTabString : PaginatedAdvancementsClient.getPinnedTabs()) {
                ...
                for (PaginatedAdvancementTab advancementTab : this.tabs.values()) {
                    if (advancementTab.getRoot().holder().id().equals(pinnedTabResourceLocation)) {
        ...
        if (this.selectedTab != null && PaginatedAdvancementsClient.CONFIG.PinningEnabled) {
            if (isClickOnFavouritesButton(mouseX, mouseY, startY, endX)) {
                if (PaginatedAdvancementsClient.isPinned(this.selectedTab.getRoot().holder().id())) {
                    context.blit(RenderType::guiTextured, PAGINATION_TEXTURE, endX - FAVOURITES_BUTTON_OFFSET_X, startY + FAVOURITES_BUTTON_OFFSET_Y, FAVOURITES_BUTTON_WIDTH, 46 + FAVOURITES_BUTTON_HEIGHT, FAVOURITES_BUTTON_WIDTH, FAVOURITES_BUTTON_HEIGHT, 256, 256);
                } else {
                    context.blit(RenderType::guiTextured, PAGINATION_TEXTURE, endX - FAVOURITES_BUTTON_OFFSET_X, startY + FAVOURITES_BUTTON_OFFSET_Y, 0, 46 + FAVOURITES_BUTTON_HEIGHT, FAVOURITES_BUTTON_WIDTH, FAVOURITES_BUTTON_HEIGHT, 256, 256);
                }
            } else {
                if (PaginatedAdvancementsClient.isPinned(this.selectedTab.getRoot().holder().id())) {
                    context.blit(RenderType::guiTextured, PAGINATION_TEXTURE, endX - FAVOURITES_BUTTON_OFFSET_X, startY + FAVOURITES_BUTTON_OFFSET_Y, FAVOURITES_BUTTON_WIDTH, 46, FAVOURITES_BUTTON_WIDTH, FAVOURITES_BUTTON_HEIGHT, 256, 256);
                } else {
                    context.blit(RenderType::guiTextured, PAGINATION_TEXTURE, endX - FAVOURITES_BUTTON_OFFSET_X, startY + FAVOURITES_BUTTON_OFFSET_Y, 0, 46, FAVOURITES_BUTTON_WIDTH, FAVOURITES_BUTTON_HEIGHT, 256, 256);
                }
            }

            if (hasPins) {
                // draw pinned tab header
                context.blit(RenderType::guiTextured, PAGINATION_TEXTURE, endX + PinnedAdvancementTabType.getTabX() + 1, startY + 6, 46, 0, 32, 15, 256, 256);
            }
        }
    }
    ...
    public void drawPaginationButtons(GuiGraphics context, int mouseX, int mouseY, int startX, int endX) {
        if (isClickOnBackTab(mouseX, mouseY, startX, endX)) {
            // hover
            context.blit(RenderType::guiTextured, PAGINATION_TEXTURE, startX + 4, TOP_ELEMENT_HEIGHT + ADDITIONAL_PADDING_TOP - 15, 0, 23, 23, 23, 256, 256);
        } else {
            // no hover
            context.blit(RenderType::guiTextured, PAGINATION_TEXTURE, startX + 4, TOP_ELEMENT_HEIGHT + ADDITIONAL_PADDING_TOP - 15, 0, 0, 23, 23, 256, 256);
        }

        if (isClickOnForwardTab(mouseX, mouseY, startX, endX)) {
            // hover
            context.blit(RenderType::guiTextured, PAGINATION_TEXTURE, endX - startX + 4, TOP_ELEMENT_HEIGHT + ADDITIONAL_PADDING_TOP - 15, 23, 23, 23, 23, 256, 256);
        } else {
            // no hover
            context.blit(RenderType::guiTextured, PAGINATION_TEXTURE, endX - startX + 4, TOP_ELEMENT_HEIGHT + ADDITIONAL_PADDING_TOP - 15, 23, 0, 23, 23, 256, 256);
        }
    }
    ...
    private void drawFrame(GuiGraphics context, int startX, int startY, int endX, int endY) {
        // corners
        context.blit(RenderType::guiTextured, WINDOW_TEXTURE, startX, startY, 0, 0, ELEMENT_WIDTH, TOP_ELEMENT_HEIGHT, 256, 256); // top left
        context.blit(RenderType::guiTextured, WINDOW_TEXTURE, endX - ELEMENT_WIDTH, startY, 237, 0, ELEMENT_WIDTH, TOP_ELEMENT_HEIGHT, 256, 256); // top right
        context.blit(RenderType::guiTextured, WINDOW_TEXTURE, startX, endY - BOTTOM_ELEMENT_HEIGHT, 0, 125, ELEMENT_WIDTH, BOTTOM_ELEMENT_HEIGHT, 256, 256); // bottom left
        context.blit(RenderType::guiTextured, WINDOW_TEXTURE, endX - ELEMENT_WIDTH, endY - BOTTOM_ELEMENT_HEIGHT, 237, 125, ELEMENT_WIDTH, BOTTOM_ELEMENT_HEIGHT, 256, 256); // bottom right
        ...
        while (middleHeight > 0) {
            ...
            context.blit(RenderType::guiTextured, WINDOW_TEXTURE, startX, currentY, 0, TOP_ELEMENT_HEIGHT, ELEMENT_WIDTH, currentDrawHeight, 256, 256);
            context.blit(RenderType::guiTextured, WINDOW_TEXTURE, endX - ELEMENT_WIDTH, currentY, 237, TOP_ELEMENT_HEIGHT, ELEMENT_WIDTH, currentDrawHeight, 256, 256);
        ...
        while (middleWidth > 0) {
            ...
            context.blit(RenderType::guiTextured, WINDOW_TEXTURE, currentX, startY, ELEMENT_WIDTH, 0, currentDrawWidth, TOP_ELEMENT_HEIGHT, 256, 256);
            context.blit(RenderType::guiTextured, WINDOW_TEXTURE, currentX, endY - BOTTOM_ELEMENT_HEIGHT, ELEMENT_WIDTH, 125, currentDrawWidth, BOTTOM_ELEMENT_HEIGHT, 256, 256);
    ...
    private void pinTab(ResourceLocation pageResourceLocation) {
        ...
        this.pinnedTabs.put(selectedTab.getRoot().holder(), selectedTab);
    ...
    private void unpinTab(ResourceLocation pageResourceLocation) {
        ...
        this.pinnedTabs.remove(selectedTab.getRoot().holder());
