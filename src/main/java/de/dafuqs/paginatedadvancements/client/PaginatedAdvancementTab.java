...
public class PaginatedAdvancementTab extends AdvancementTab {
    ...
    public void render(GuiGraphics context, int startX, int startY, int endX, int endY) {
        ...
        for (int m = -1; m < textureCountX; ++m) {
            for (int n = -1; n < textureCountY; ++n) {
                context.blit(RenderType::guiTextured, identifier, k + 16 * m, l + 16 * n, 0.0F, 0.0F, 16, 16, 16, 16);
            }
        }
    ...
    public void drawDebugInfo(GuiGraphics context, int startX, int startY, int endX, int endY) {
        if (this.hoveredWidget != null) {
            ...
            List<MutableComponent> requirements = getRequirements(startX, endX - 10, advancementWidgetAccessor.getAdvancement().advancement(), progress);
            ...
            if (PaginatedAdvancementsClient.CONFIG.ShowAdvancementIDInDebugTooltip) {
                Component idText = Component.literal("ID: " + advancementWidgetAccessor.getAdvancement().holder().id() + " ").append(Component.translatable("text.paginated_advancements.copy_to_clipboard"));
    ...
    protected void drawDebugFrame(GuiGraphics context, int startX, int startY, int endX, int endY) {
        ...
        // corners
        context.blit(RenderType::guiTextured, PaginatedAdvancementScreen.WINDOW_TEXTURE, startX, startY, 0, 0, ELEMENT_WIDTH, TOP_ELEMENT_HEIGHT, 256, 256); // top left
        context.blit(RenderType::guiTextured, PaginatedAdvancementScreen.WINDOW_TEXTURE, endX - ELEMENT_WIDTH, startY, 237, 0, ELEMENT_WIDTH, TOP_ELEMENT_HEIGHT, 256, 256); // top right
        context.blit(RenderType::guiTextured, PaginatedAdvancementScreen.WINDOW_TEXTURE, startX, endY - BOTTOM_ELEMENT_HEIGHT, 0, 125, ELEMENT_WIDTH, BOTTOM_ELEMENT_HEIGHT, 256, 256); // bottom left
        context.blit(RenderType::guiTextured, PaginatedAdvancementScreen.WINDOW_TEXTURE, endX - ELEMENT_WIDTH, endY - BOTTOM_ELEMENT_HEIGHT, 237, 125, ELEMENT_WIDTH, BOTTOM_ELEMENT_HEIGHT, 256, 256); // bottom right
        ...
        while (middleHeight > 0) {
            ...
            context.blit(RenderType::guiTextured, PaginatedAdvancementScreen.WINDOW_TEXTURE, startX, currentY, 0, TOP_ELEMENT_HEIGHT, ELEMENT_WIDTH, currentDrawHeight, 256, 256);
            context.blit(RenderType::guiTextured, PaginatedAdvancementScreen.WINDOW_TEXTURE, endX - ELEMENT_WIDTH, currentY, 237, TOP_ELEMENT_HEIGHT, ELEMENT_WIDTH, currentDrawHeight, 256, 256);
        ...
        while (middleWidth > 0) {
            ...
            context.blit(RenderType::guiTextured, PaginatedAdvancementScreen.WINDOW_TEXTURE, currentX, startY, ELEMENT_WIDTH, 0, currentDrawWidth, TOP_ELEMENT_HEIGHT, 256, 256);
            context.blit(RenderType::guiTextured, PaginatedAdvancementScreen.WINDOW_TEXTURE, currentX, endY - BOTTOM_ELEMENT_HEIGHT, ELEMENT_WIDTH, 125, currentDrawWidth, BOTTOM_ELEMENT_HEIGHT, 256, 256);
        ...
        while (drawHeight > 0) {
            ...
            while (drawWidth > 0) {
                ...
                context.blit(RenderType::guiTextured, PaginatedAdvancementScreen.WINDOW_TEXTURE, drawStartX, drawStartY, 4, 4, currentWidth, currentHeight, 256, 256);
